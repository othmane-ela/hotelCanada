...
import AboutSingle from "../about/AboutSingle"
import SingleAll from "../all/SingleAll"
...
function RoomSlide() {
    ...
    return (
        <>
            <div className="slide" style={{ background: "linear-gradient(rgb(15, 15, 15), rgb(0 0 0 / 48%)), url(images/chambre_single/IMG_0338.jpg)" ,
