...
import AboutDouble from "../about/AboutDouble"
import DoubleAll from "../all/DoubleAll"
...
function RoomSlide() {
    ...
    return (
        <>
            <div className="slide" style={{ background: "linear-gradient(rgb(15, 15, 15), rgb(0 0 0 / 48%)), url(images/chambre_double/3K9C0098.jpg)" ,
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-house-door text-light m-2" viewBox="0 0 16 16">
               ...
               <div className="col-md-8 bottom-slide py-4">
                ...
                <div>
                  <Link to='/doubleGallery'>
                      <div className="magic-card text-center">
                                  <img src="images/chambre_double/IMG_0064.jpg" alt="Double image_01" className="magic-card__image"/>
                ...
                <div>
                  <Link to='/doubleGallery'>
                      <div className="magic-card text-center">
                                  <img src="images/chambre_double/IMG_0078.jpg" alt="Double image_02" className="magic-card__image"/>
                                  <div className="black-overlay"></div>
                      </div>
                  </Link>
                </div>
                <div>
                  <Link to='/doubleGallery'>
                      <div className="magic-card text-center">
                                  <img src="images/chambre_double/IMG_0324.jpg" alt="Double image_03" className="magic-card__image"/>
                                  <div className="black-overlay"></div>
                      </div>
                  </Link>
                </div>
