...
import AboutRestau from "../about/AboutRestau"
import RestauAll from "../all/RestauAll"
...
function RestaurantSlide(props) {
    ...
    return (
        <>
            <div className="slide" style={{ background: "linear-gradient( rgb(15, 15, 15), rgb(0 0 0 / 48%)), url(images/restau-bg.jpg)" ,
            ...
            <div className="blur-right d-none d-md-block"></div>
                        ...
                        <div className="col-md-2 ">
                              ...
                              <Link to='/'>
                                <div className="next-slide">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-chevron-left next-slide-icon" viewBox="0 0 16 16">
              ...
              <div className="col-md-4 text-center pb-4 left-side-text d-none d-md-block">
               ...
               <div className="col-md-8 bottom-slide py-4">
                ...
                <Link to='/restaurant'>
                    <div className="magic-card text-center">
                                <img src="images/restau/121810593_2849167431984707_1865371083927997772_n.jpg" alt="room" className="magic-card__image"/>
                                <div className="black-overlay"></div>
                                    <div className="magic-card__text-no-wrapper">
                                        <h4 className="magic-card__title">Restaurant</h4>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
